...
export class EntityContext implements Serializable<SerializedEntityContext> {
  constructor(
    public module: ModuleIdentifier,
    public id: string,
  ) {}
  ...
  static fromJSON<C extends typeof EntityContext>(
    this: C,
    json: SerializedEntityContext,
  ): InstanceType<C> {
    return new EntityContext(json.module, json.id) as InstanceType<C>;
  }
...
export type ContextOfEntity<E extends Entity<any, any>> =
  E extends Entity<infer C, any> ? C : never;
    ...
    implements Serializable<SerializedEntity<Entity<Context, Data>>>
  {
    ...
    reset() {
      const palette = this.context
        ? (schemer.get(this.context) as SerializableEntity | null)
        : null;
    ...
    static createDefault<Ctor extends typeof SerializableEntity>(
      ...
      return SerializableEntity.create(name, data, context) as InstanceType<Ctor>;
    }
  };
...
export type EntityOfManager<M extends EntityManager<any>> =
  M extends EntityManager<infer E> ? E : never;
