...
import { createEditor, type Descendant, Editor, Range, Transforms } from "https://esm.sh/slate";
import { withHistory } from "https://esm.sh/slate-history";
import type * as SlateReact from "https://esm.sh/slate-react";
import {
  Editable,
  ReactEditor,
  Slate,
...
import type { MentionElement, RenderCustomElementProps } from "./custom-types.d.ts";
...
const MentionExample = () => {
  ...
  const renderElement = useCallback(
    (props: SlateReact.RenderElementProps) => <Element {...props} />,
    [],
  );
