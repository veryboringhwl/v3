...
async function createRemoteModuleInstance(
...
export default function ({ aurl }: { aurl?: string }) {
  ...
  const [moduleInstance, refetchModuleInstance] = useModuleInstance(
    moduleIdentifier,
    version,
    aurl,
  );
  ...
  return (
    <section className="contentSpacing">
      <div className="marketplace-header items-center flex justify-between pb-2 flex-row z-10">
        ...
        <div className="marketplace-header__right flex gap-2">{Button}</div>
      </div>
