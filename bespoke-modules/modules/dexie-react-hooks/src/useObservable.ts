...
export function useObservable<T, _TDefault>(observable: InteropableObservable<T>): T | undefined;
...
export function useObservable<T, TDefault>(
  ...
  const observable = React.useMemo(() => {
    ...
    // resubscribing.
    const observable =
      typeof observableFactory === "function" ? observableFactory() : observableFactory;
