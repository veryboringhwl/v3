...
declare global {
  var __patchTracklistWrapperProps: Identity<{ renderRow: RenderRow; columns: string[] }>;
  var __patchRenderTracklistRowColumn: (columnType: string) => React.ReactNode;
  var __patchTracklistColumnHeaderContextMenu: (columnType: string) => React.FC<{}>;
...
globalThis.__patchTracklistColumnsProvider = (columns) => {
  ...
  return React.useMemo(
    () => [...columns.slice(0, i), ...COLUMN_TYPES_EVERYWHERE, ...columns.slice(i)],
    [columns],
  );
};
...
declare global {
  ...
  var __patchSortKeyToDefaultSortOptionsMap: Identity<SortKeyToDefaultSortOptionsMap>;
  var __patchSortKeyToColumnTypeMap: Identity<SortKeyToColumnTypeMap>;
  var __patchColumnTypeToSortFieldMap: Identity<ColumnTypeToSortFieldColumnMap>;
}
