...
export const fetchArtistLikedTracks = async (uri: string, offset = 0, limit = 100) =>
...
export const createFolder = async (name: string, location: Platform.RootlistAPI.Location = {}) =>
...
export const createPlaylist = async (name: string, location: Platform.RootlistAPI.Location = {}) =>
...
export const createPlaylistFromTracks = (name: string, tracks: string[], folder?: string) =>
  Platform.getCosmos().post("sp://core-playlist/v1/rootlist?responseFormat=protobufJson", {
    operation: "create",
    ...(folder ? { after: folder } : {}),
    name,
    playlist: true,
...
export const setPlaylistPublished = async (playlist: string, published: boolean) =>
...
export const removePlaylistTracks = (playlist: string, tracks: Array<{ uid: string }>) =>
